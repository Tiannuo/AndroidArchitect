...
import com.tikou.libannotation.OnClick
import java.util.*
...
class ButterKnifeProcessor : AbstractProcessor() {
    ...
    override fun process(p0: MutableSet<out TypeElement>?, p1: RoundEnvironment?): Boolean {
        ...
        p1!!.rootElements.forEach { rootElement ->
            ...
            rootElement.enclosedElements.forEach { element ->
                // @BindView
                val bindViewAnnotation = element.getAnnotation(IBindView::class.java)
    ...
    override fun getSupportedAnnotationTypes(): MutableSet<String> {
        return Collections.singleton(IBindView::class.java.canonicalName)
    }
